...
import logo from '../../images/CClogo.jpeg'
                           ...
                           <div className="form-container">
                              ...
                              <form onSubmit={this.handleSubmit} >
                                 ...
                                 <div className="tos_acceptance">
                                    <div>
                                       <Link to='/signup'>By signing up, you accept the CollabCash Terms of Service.</Link>
                                    </div>

                                    {
                                       isActive &&
                                       <div>
                                          Don't use INR for currency? <Link to='/signup'>Click here</Link>
                                       </div>
                                    }
